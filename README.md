...
- 设置页可选择显示或隐藏工作过程（CoT）、工具活动与处理步骤；默认显示。
...
随后在 Zotero 中打开“工具 → 插件”，点击齿轮按钮，选择“Install Plugin From File…”，安装 `dist/zotero-codex-sidebar-2026.259.1.xpi`。选中文献或打开 PDF 后，点击右侧边栏中的 Codex 图标。
